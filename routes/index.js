...
{_id: req.user._id, name: req.user.name, surname: req.user.surname, email: req.user.email, age: req.user.age, imageProfile: req.user.imageProfile, friends: req.user.friends, friendRequests: req.user.friendRequests, status: req.user.status}));
